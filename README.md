...
1.解開壓縮包，將upload資料夾上傳至您的網站
2.建立一個新的資料庫之後複製或上傳fguestbook.sql檔案至phpMyAdmin中並執行其中的語法。
3.修改connectdb.php，將 mysql_connect('localhost','db_username','db_password')
